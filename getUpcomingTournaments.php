...
if(isset($_POST['gameOptions'])){
    ...
    $sql = "SELECT t1.tournament_Name, t1.start_date, t1.num_players_registered AS players_registered, t1.num_teams_registered AS teams_registered, t1.owner, t1.totalPrize, t2.title FROM tournament t1 INNER JOIN game t2 ON t2.game_ID = t1.gameID WHERE t1.start_date > DATE(NOW()) AND t2.title = ?;";
